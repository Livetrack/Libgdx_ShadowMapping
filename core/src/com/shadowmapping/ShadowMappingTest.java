...
import com.shadowmapping.DLightShader;
import com.shadowmapping.DirectionalLight;
import com.shadowmapping.ShadowShader;
...
public class ShadowMappingTest extends ApplicationAdapter {
	...
	public void create () {
		...
		sphere = modelBuilder.createSphere(50f, 50f, 50f, 20, 20, new Material(), Usage.Position | Usage.Normal | Usage.TextureCoordinates);
		sphereInstance = new ModelInstance(sphere, 10f,10f,10f);
	    plane = modelBuilder.createBox(500.0f, 2.0f, 500.0f, new Material(new ColorAttribute(ColorAttribute.Diffuse, Color.GREEN)), Usage.Position| Usage.Normal | Usage.TextureCoordinates);
	    planeInstance = new ModelInstance(plane, 0.0f, 0.0f, 0.0f);
